...
//定义一个服务端类，用于接收客户端的请求，并调用服务类的方法进行处理，然后将结果返回给客户端
public class Server {
    //定义一个服务对象，用于调用服务类的方法
                ...
                while (true) {
                    ...
                    switch (type) {
                        ...
                        case "query": //查询联系人请求
                            ...
                            //调用服务类的查询联系人方法，传入姓名作为参数，并返回一个联系人对象或null
                            ...
                            break;
                        case "show": //显示所有联系人请求
                            //调用服务类的显示所有联系人方法，并返回一个包含所有联系人信息的字符串
